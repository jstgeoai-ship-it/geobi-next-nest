...
export const TOUR_STEPS: TourStep[] = [
  ...
  {
    el: '#tour-gauge',
    title: 'Capaian Realisasi vs Target',
    desc: 'Jarum menunjukkan <b>persentase realisasi</b> terhadap target. Di bawahnya: nilai realisasi, target, dan sisa yang <b>belum tertagih</b>.<br><br><b>Gunanya:</b> menjawab &ldquo;sudah sejauh mana capaian penerimaan pajak?&rdquo;',
  },
  {
    el: '#tour-ringkasan',
