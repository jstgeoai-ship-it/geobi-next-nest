...
export function Navbar() {
  ...
  `flex items-center gap-1 px-2 rounded-lg text-[12px] font-medium transition-colors ${
    active ? 'text-orange-400 font-semibold' : 'text-white/80 light:text-gray-700 hover:text-white light:hover:text-gray-900 hover:bg-white/5 light:hover:bg-gray-900/5'
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-black/40 light:bg-slate-100 backdrop-blur-md light:backdrop-blur-none light:shadow-sm">
      <div className="px-8 flex h-16 items-center justify-between">
              ...
              <div className="absolute left-0 top-full pt-2 z-50" style={{ minWidth: 260 }}>
                <div className="bg-slate-900 light:bg-slate-50 border border-white/10 light:border-gray-200 rounded-xl shadow-2xl overflow-hidden">
                  <Link href={linkHref('/katalog/pbb-p2')} className="flex items-center gap-3 px-4 py-2.5 hover:bg-white/5 light:hover:bg-gray-900/5 transition-colors group">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        <p className="text-[10px] font-semibold text-white light:text-gray-900 group-hover:text-orange-400 transition-colors">Peta Tematik Pembayaran PBB-P2</p>
                        {!user && (
                      ...
                      <p className="text-[11px] leading-snug text-slate-400 light:text-gray-500 mt-0.5">Visualisasi distribusi pembayaran PBB-P2 per wilayah.</p>
                    </div>
                  </Link>
                  ...
                  <Link href={linkHref('/katalog/dashboard-pbb/v3')} className="flex items-center gap-3 px-4 py-2.5 hover:bg-white/5 light:hover:bg-gray-900/5 transition-colors group">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        <p className="text-[10px] font-semibold text-white light:text-gray-900 group-hover:text-orange-400 transition-colors">Intelligence Dashboard Pembayaran PBB-P2</p>
                        {!user && (
                          <svg className="w-3.5 h-3.5 text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25-2.25v6.75a2.25 2.25 0 002.25 2.25z" />
                          </svg>
                      ...
                      <p className="text-[11px] leading-snug text-slate-400 light:text-gray-500 mt-0.5">Dashboard analitik untuk monitoring pembayaran PBB-P2.</p>
                    </div>
                  </Link>
                </div>
              </div>
              ...
              <div className="absolute left-0 top-full pt-2 z-50" style={{ minWidth: 260 }}>
                <div className="bg-slate-900 light:bg-slate-50 border border-white/10 light:border-gray-200 rounded-xl shadow-2xl overflow-hidden">
                  <Link href={linkHref('/penilaian/peta-tematik')} className="flex items-center gap-3 px-4 py-2.5 hover:bg-white/5 light:hover:bg-gray-900/5 transition-colors group">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        <p className="text-[10px] font-semibold text-white light:text-gray-900 group-hover:text-orange-400 transition-colors">Peta Tematik Penilaian PBB-P2</p>
                        {!user && (
                          <svg className="w-3.5 h-3.5 text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25-2.25v6.75a2.25 2.25 0 002.25 2.25z" />
                          </svg>
                      ...
                      <p className="text-[11px] leading-snug text-slate-400 light:text-gray-500 mt-0.5">Visualisasi hasil penilaian PBB-P2 per wilayah.</p>
                    </div>
                  </Link>
                  ...
                  <Link href={linkHref('/penilaian/intelligence-dashboard')} className="flex items-center gap-3 px-4 py-2.5 hover:bg-white/5 light:hover:bg-gray-900/5 transition-colors group">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        <p className="text-[10px] font-semibold text-white light:text-gray-900 group-hover:text-orange-400 transition-colors">Intelligence Dashboard Penilaian PBB-P2</p>
                        {!user && (
                          <svg className="w-3.5 h-3.5 text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25-2.25v6.75a2.25 2.25 0 002.25 2.25z" />
                          </svg>
                      ...
                      <p className="text-[11px] leading-snug text-slate-400 light:text-gray-500 mt-0.5">Dashboard analitik untuk monitoring penilaian PBB-P2.</p>
                    </div>
                  </Link>
                  ...
                  <Link href={linkHref('/penilaian/3d-monitoring-njop')} className="flex items-center gap-3 px-4 py-2.5 hover:bg-white/5 light:hover:bg-gray-900/5 transition-colors group">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        <p className="text-[10px] font-semibold text-white light:text-gray-900 group-hover:text-orange-400 transition-colors">Peta Tematik 3D Monitoring Penyesuaian NJOP Bumi</p>
                        {!user && (
                          <svg className="w-3.5 h-3.5 text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25-2.25v6.75a2.25 2.25 0 002.25 2.25z" />
                          </svg>
                      ...
                      <p className="text-[11px] leading-snug text-slate-400 light:text-gray-500 mt-0.5">Visualisasi 3D untuk monitoring penyesuaian NJOP bumi.</p>
                    </div>
                  </Link>
                </div>
              </div>
              ...
              <div className="absolute left-0 top-full pt-2 z-50" style={{ minWidth: 260 }}>
                <div className="bg-slate-900 light:bg-slate-50 border border-white/10 light:border-gray-200 rounded-xl shadow-2xl overflow-hidden">
                  <Link href={linkHref('/pendataan/peta-tematik')} className="flex items-center gap-3 px-4 py-2.5 hover:bg-white/5 light:hover:bg-gray-900/5 transition-colors group">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        <p className="text-[10px] font-semibold text-white light:text-gray-900 group-hover:text-orange-400 transition-colors">Peta Tematik Pendataan PBB-P2</p>
                        {!user && (
                          <svg className="w-3.5 h-3.5 text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25-2.25v6.75a2.25 2.25 0 002.25 2.25z" />
                          </svg>
                      ...
                      <p className="text-[11px] leading-snug text-slate-400 light:text-gray-500 mt-0.5">Visualisasi data pendataan PBB-P2 per wilayah.</p>
                    </div>
                  </Link>
                  ...
                  <Link href={linkHref('/pendataan/intelligence-dashboard')} className="flex items-center gap-3 px-4 py-2.5 hover:bg-white/5 light:hover:bg-gray-900/5 transition-colors group">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        <p className="text-[10px] font-semibold text-white light:text-gray-900 group-hover:text-orange-400 transition-colors">Intelligence Dashboard Pendataan PBB-P2</p>
                        {!user && (
                          <svg className="w-3.5 h-3.5 text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25-2.25v6.75a2.25 2.25 0 002.25 2.25z" />
                          </svg>
                      ...
                      <p className="text-[11px] leading-snug text-slate-400 light:text-gray-500 mt-0.5">Dashboard analitik untuk monitoring pendataan PBB-P2.</p>
                    </div>
                  </Link>
                </div>
              </div>
              ...
              <div className="absolute left-0 top-full pt-2 z-50" style={{ minWidth: 260 }}>
                <div className="bg-slate-900 light:bg-slate-50 border border-white/10 light:border-gray-200 rounded-xl shadow-2xl overflow-hidden">
                  <Link href={linkHref('/kepatuhan/peta-tematik')} className="flex items-center gap-3 px-4 py-2.5 hover:bg-white/5 light:hover:bg-gray-900/5 transition-colors group">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        <p className="text-[10px] font-semibold text-white light:text-gray-900 group-hover:text-orange-400 transition-colors">Peta Tematik Kepatuhan PBB-P2</p>
                        {!user && (
                          <svg className="w-3.5 h-3.5 text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25-2.25v6.75a2.25 2.25 0 002.25 2.25z" />
                          </svg>
                      ...
                      <p className="text-[11px] leading-snug text-slate-400 light:text-gray-500 mt-0.5">Visualisasi tingkat kepatuhan pembayaran PBB-P2 per wilayah.</p>
                    </div>
                  </Link>
                  ...
                  <Link href={linkHref('/kepatuhan/intelligence-dashboard')} className="flex items-center gap-3 px-4 py-2.5 hover:bg-white/5 light:hover:bg-gray-900/5 transition-colors group">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        <p className="text-[10px] font-semibold text-white light:text-gray-900 group-hover:text-orange-400 transition-colors">Intelligence Dashboard Kepatuhan PBB-P2</p>
                        {!user && (
                          <svg className="w-3.5 h-3.5 text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25-2.25v6.75a2.25 2.25 0 002.25 2.25z" />
                          </svg>
                      ...
                      <p className="text-[11px] leading-snug text-slate-400 light:text-gray-500 mt-0.5">Dashboard analitik untuk monitoring kepatuhan PBB-P2.</p>
                    </div>
                  </Link>
                </div>
              </div>
              ...
              <div className="absolute left-0 top-full pt-2 z-50" style={{ minWidth: 260 }}>
                <div className="bg-slate-900 light:bg-slate-50 border border-white/10 light:border-gray-200 rounded-xl shadow-2xl overflow-hidden">
                  <Link href={linkHref('/piutang/peta-tematik')} className="flex items-center gap-3 px-4 py-2.5 hover:bg-white/5 light:hover:bg-gray-900/5 transition-colors group">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        <p className="text-[10px] font-semibold text-white light:text-gray-900 group-hover:text-orange-400 transition-colors">Peta Tematik Piutang PBB-P2</p>
                        {!user && (
                          <svg className="w-3.5 h-3.5 text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25-2.25v6.75a2.25 2.25 0 002.25 2.25z" />
                          </svg>
                      ...
                      <p className="text-[11px] leading-snug text-slate-400 light:text-gray-500 mt-0.5">Visualisasi piutang PBB-P2 per wilayah.</p>
                    </div>
                  </Link>
                  ...
                  <Link href={linkHref('/piutang/intelligence-dashboard')} className="flex items-center gap-3 px-4 py-2.5 hover:bg-white/5 light:hover:bg-gray-900/5 transition-colors group">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        <p className="text-[10px] font-semibold text-white light:text-gray-900 group-hover:text-orange-400 transition-colors">Intelligence Dashboard Piutang PBB-P2</p>
                        {!user && (
                          <svg className="w-3.5 h-3.5 text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25-2.25v6.75a2.25 2.25 0 002.25 2.25z" />
                          </svg>
                      ...
                      <p className="text-[11px] leading-snug text-slate-400 light:text-gray-500 mt-0.5">Dashboard analitik untuk monitoring piutang PBB-P2.</p>
                    </div>
                  </Link>
                </div>
              </div>
        ...
        <div className="hidden md:flex items-center gap-3 shrink-0">
          {user ? (
            <div className="relative" onMouseEnter={() => setAccountOpen(true)} onMouseLeave={() => setAccountOpen(false)}>
              <button type="button" className="flex items-center gap-1 text-[12.5px] text-slate-400 light:text-gray-600 hover:text-white light:hover:text-gray-900 transition-colors whitespace-nowrap">
                {user.name}
                <svg className={`w-3 h-3 opacity-60 transition-transform duration-200 ${accountOpen ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M19 9l-7 7-7-7" />
                </svg>
              </button>
              ...
              {accountOpen && (
                <div className="absolute right-0 top-full pt-2 z-50" style={{ minWidth: 170 }}>
                  <div className="bg-slate-900 light:bg-slate-50 border border-white/10 light:border-gray-200 rounded-xl shadow-2xl overflow-hidden">
                    <Link href="/profile" className="block px-4 py-2.5 text-xs text-white/80 light:text-gray-700 hover:bg-white/5 light:hover:bg-gray-900/5 hover:text-white light:hover:text-gray-900 transition-colors">
                      Profile
                    </Link>
                    <Link href="/settings" className="block px-4 py-2.5 text-xs text-white/80 light:text-gray-700 hover:bg-white/5 light:hover:bg-gray-900/5 hover:text-white light:hover:text-gray-900 transition-colors">
                      Settings
                    </Link>
            ...
            <>
              <Link href="/register" className="text-xs px-3 py-2 rounded-lg border border-white/20 light:border-gray-300 text-white/80 light:text-gray-700 hover:bg-white/5 light:hover:bg-gray-900/5 transition-colors whitespace-nowrap">
                Daftar
              </Link>
        ...
        {/* Mobile menu button */}
        <button className="md:hidden text-white/80 light:text-gray-700 p-2" onClick={() => setMobileOpen((v) => !v)}>
          {mobileOpen ? (
      ...
      {mobileOpen && (
        <div className="md:hidden border-t border-white/10 light:border-gray-200 bg-black/60 light:bg-slate-100/95 backdrop-blur-md px-6 py-4 flex flex-col gap-2 text-sm">
          <Link href="/" className={`py-2 text-white/80 light:text-gray-700 hover:text-white light:hover:text-gray-900 ${pathname === '/' ? 'text-orange-400 font-semibold' : ''}`}>Home</Link>
          <Link href="/katalog" className={`py-2 text-white/80 light:text-gray-700 hover:text-white light:hover:text-gray-900 ${isActive('/katalog') ? 'text-orange-400 font-semibold' : ''}`}>GeoBI Pembayaran</Link>
          <Link href="/penilaian" className={`py-2 text-white/80 light:text-gray-700 hover:text-white light:hover:text-gray-900 ${isActive('/penilaian') ? 'text-orange-400 font-semibold' : ''}`}>GeoBI Penilaian</Link>
          <Link href="/pendataan" className={`py-2 text-white/80 light:text-gray-700 hover:text-white light:hover:text-gray-900 ${isActive('/pendataan') ? 'text-orange-400 font-semibold' : ''}`}>GeoBI Pendataan</Link>
          <Link href="/kepatuhan" className={`py-2 text-white/80 light:text-gray-700 hover:text-white light:hover:text-gray-900 ${isActive('/kepatuhan') ? 'text-orange-400 font-semibold' : ''}`}>GeoBI Kepatuhan</Link>
          <Link href="/piutang" className={`py-2 text-white/80 light:text-gray-700 hover:text-white light:hover:text-gray-900 ${isActive('/piutang') ? 'text-orange-400 font-semibold' : ''}`}>GeoBI Piutang</Link>
          <Link href="/tentang" className={`py-2 text-white/80 light:text-gray-700 hover:text-white light:hover:text-gray-900 ${isActive('/tentang') ? 'text-orange-400 font-semibold' : ''}`}>Tentang GeoBI</Link>
          <div className="border-t border-white/10 light:border-gray-200 pt-3 mt-1">
            {user ? (
              <>
                <Link href="/profile" className="block text-slate-400 light:text-gray-600 hover:text-white light:hover:text-gray-900 mb-2">{user.name}</Link>
                <Link href="/settings" className="block text-slate-400 light:text-gray-600 hover:text-white light:hover:text-gray-900 mb-2">Settings</Link>
