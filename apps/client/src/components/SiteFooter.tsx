      ...
      <div style={{ maxWidth, margin: '0 auto', padding: '48px 32px 32px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr 1fr', gap: 40, marginBottom: 40 }}>
          <div>
            ...
            <p style={{ fontSize: 13, color: 'var(--pub-muted-3)', lineHeight: 1.7 }}>{description}</p>
          </div>

          <div>
            <p style={{ fontSize: 11, fontWeight: 700, color: 'var(--pub-text)', textTransform: 'uppercase', letterSpacing: '.08em', marginBottom: 16 }}>Informasi Kontak</p>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10 }}>
                ...
                <span style={{ fontSize: 13, color: 'var(--pub-muted-2)', lineHeight: 1.5 }}>Jl. Abdul Muis No. 66,<br />Jakarta Pusat</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                <span style={{ fontSize: 13, color: 'var(--pub-muted-2)' }}>(021) 3865656</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                <span style={{ fontSize: 13, color: 'var(--pub-muted-2)' }}>bapenda@jakarta.go.id</span>
              </div>
            </div>
          </div>

          <div>
            <p style={{ fontSize: 11, fontWeight: 700, color: 'var(--pub-text)', textTransform: 'uppercase', letterSpacing: '.08em', marginBottom: 16 }}>Tautan Terkait</p>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
              {LINKS.map((link) => (
                <a key={link} href="#" style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 13, color: 'var(--pub-muted-2)', textDecoration: 'none', padding: '4px 0' }}>
        ...
        <div style={{ borderTop: '1px solid var(--pub-border)', paddingTop: 20, textAlign: 'center', fontSize: 12, color: 'var(--pub-muted-3)' }}>
